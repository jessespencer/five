...
export const drinks: Record<string, Drink> = {
  ...
  "Taiohae": {
    name: "Pamplemousse Punch",
    city: "Taiohae",
    type: "cocktail",
    tagline: "Drink like a local",
    description: "A Marquesan rum punch built around pamplemousse — the giant Polynesian pomelo that grows wild across the islands.",
    recipe: {
      ingredients: [
        { amount: "2 oz", item: "Aged rum" },
        { amount: "1.5 oz", item: "Fresh pomelo juice (or pink grapefruit)" },
        { amount: "0.5 oz", item: "Lime juice" },
        { amount: "0.5 oz", item: "Cane syrup" },
        { amount: "Splash", item: "Soda water" },
      ],
      instructions: [
        "Combine rum, pomelo juice, lime, and cane syrup in a shaker with ice.",
        "Shake well until chilled.",
        "Strain into a tall glass over fresh ice.",
        "Top with a splash of soda.",
      ],
      glass: "Tall glass",
      garnish: "Pomelo wedge and a hibiscus flower",
    },
    isAlcoholic: true,
  },
  "Gambier Islands": {
  ...
  "Lord Howe Island": {
    ...
    type: "cocktail",
    tagline: "Drink like a local",
    description: "A breezy sundowner named for the Kentia palm — Lord Howe's most famous export and the green canopy over its crystal lagoon.",
    recipe: {
      ingredients: [
        { amount: "1.5 oz", item: "Australian gin" },
        { amount: "0.5 oz", item: "Fresh lime juice" },
        { amount: "0.5 oz", item: "Simple syrup" },
      ...
      glass: "Highball glass",
      garnish: "Lime wheel and a palm frond",
    },
    isAlcoholic: true,
  },
  "Noumea": {
  ...
  "Waitangi": {
    ...
    type: "cocktail",
    tagline: "Drink like a local",
    description: "A warming nip for the windswept Chathams — NZ malt whisky cut with mānuka honey and lemon, built for cold nights at the edge of tomorrow.",
    recipe: {
      ingredients: [
        { amount: "1.5 oz", item: "New Zealand single malt whisky" },
        { amount: "1 tsp", item: "Mānuka honey" },
        { amount: "0.5 oz", item: "Fresh lemon juice" },
        { amount: "4 oz", item: "Hot water" },
      ],
      instructions: [
        "Add mānuka honey to a heatproof mug.",
        "Pour in whisky and lemon juice.",
  ...
  "Apia": {
    ...
    type: "non-alcoholic",
    tagline: "Drink like a local",
    description: "Samoa's ceremonial kava — pounded pepper root mixed with water and served from a carved wooden tanoa. Earthy, numbing, and steeped in protocol.",
    recipe: {
      ingredients: [
        { amount: "0.5 cup", item: "Ground 'ava (kava) root" },
        { amount: "4 cups", item: "Cool water" },
        { amount: "1", item: "Muslin cloth or strainer bag" },
      ],
      instructions: [
        "Place ground 'ava in the muslin cloth and tie loosely.",
        "Submerge in water inside a tanoa or large bowl.",
        "Knead and squeeze the cloth for several minutes to extract the 'ava.",
        "Wring out and strain — the liquid should be muddy brown.",
        "Clap once, say 'Manuia!', and drink in a single draught from a coconut shell.",
      ],
      glass: "Half coconut shell (ipu)",
      garnish: "None — served plain",
    },
    isAlcoholic: false,
  },
  "Kiritimati": {
    ...
    type: "spirit",
    tagline: "Drink like a local",
    description: "Kiribati's coconut palm toddy — tapped fresh from the flower stalk at dawn. Sweet by morning, fizzy and fermented by sundown.",
    recipe: {
      ingredients: [
        { amount: "1", item: "Coconut palm (flower stalk tapped)" },
        { amount: "As gathered", item: "Karewe (fresh palm sap)" },
      ],
      instructions: [
        "At dawn, climb the palm and slice the bound flower stalk.",
        "Hang a bottle to collect the dripping sap.",
        "Drink sweet within the first hours of tapping.",
        "Or leave it to ferment in the heat — by evening it's a tangy palm wine ('sour toddy').",
      ],
      glass: "Half coconut shell",
      garnish: "None",
    },
    isAlcoholic: true,
  },
